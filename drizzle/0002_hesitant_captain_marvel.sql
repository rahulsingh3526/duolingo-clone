DO $$ BEGIN
 CREATE TYPE "public"."type" AS ENUM('SELECT', 'ASSITS');
EXCEPTION
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "units" ADD CONSTRAINT "units_course_id_table_id_fk" FOREIGN KEY ("course_id") REFERENCES "public"."table"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
